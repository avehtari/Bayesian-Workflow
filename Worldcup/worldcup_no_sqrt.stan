...
//    log_lik[n] = student_t_lpdf(dif[n] | df, a[team_1[n]] - a[team_2[n]], sigma_y);
    log_lik[n] = log_diff_exp(student_t_lcdf(dif[n]+0.5 | df, a[team_1[n]] - a[team_2[n]], sigma_y), student_t_lcdf(dif[n]-0.5 | df, a[team_1[n]] - a[team_2[n]], sigma_y));
  }
}
