...
mod_1 <- cmdstan_model("ratings_1.stan")
...
mod_2 <- cmdstan_model("ratings_2.stan")
...
pdf("movies_2.pdf", height=4, width=6)
...
mod_3 <- cmdstan_model("ratings_3.stan")
...
pdf("movies_3.pdf", height = 4, width = 9)
par(mfrow = c(1, 2))
...
pdf("movies_4.pdf", height = 4, width = 9)
...
pdf("movies_5.pdf", height = 4, width = 9)
par(mfrow = c(1, 2))
par(mar = c(3, 3, 2, 1), mgp = c(1.7, .5, 0), tck = -0.02)
par(pty = "s")
