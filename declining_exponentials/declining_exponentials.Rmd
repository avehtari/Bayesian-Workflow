...
```{r}
print_file(root("declining_exponentials",  "exponential.stan"))
```
...
```{r}
print_file(root("declining_exponentials", "exponential_positive_lognormal.stan"))
```
...
```{r}
print_file(root("declining_exponentials", "sum_of_exponentials.stan"))
```
