...
pdf (paste ("vouchermaps", 2000, ".pdf", sep=""), height=14.5, width=14.5)
#====================
v.idx <- seq(1, 8)
h.idx <- c(0, seq(9, 13))
...
for (k in 1:7){
  pdf (paste ("voucherplots", 2000, " ", namelist[[3]][k], ".pdf", sep=""), height=15,width=15)
  ...
  mtext (paste (2000, ":  Raw and estimated support for school vouchers within each state among", namelist[[3]][k]), outer=TRUE, cex=1, side=3, line=1)
  dev.off()
}
