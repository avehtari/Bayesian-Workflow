...
par(pty="s")
plot(midterm, final, xlab="Midterm exam score", ylab="Final exam score", xlim=c(0,100), ylim=c(0,100), xaxs="i", yaxs="i",  pch=20, cex=0.5, main="If nobody gets the treatment", cex.main=0.9)
grid(5, 5)
abline(a, b)
dev.off()
...
par(pty="s")
plot(midterm, y, xlab="Midterm exam score", ylab="Final exam score", xlim=c(0,100), ylim=c(0,100), xaxs="i", yaxs="i",  type="n", main="Balanced treatment assignment", cex.main=0.9)
...
par(mar=c(3, 3, 2, 1), mgp=c(1.7, .5, 0), tck=-.01)
par(pty="m")
plot(midterm, ifelse(z==1, .99, .01), ylim=c(0,1), xlab="Pre-test score", ylab="Pr (z=1)", xaxt="n", yaxt="n", yaxs="i", bty="l", pch=20, cex=0.5)
axis(1, seq(0,100,20))
axis(2, seq(0,1,.5))
...
par(mar=c(3, 3, 2, 1), mgp=c(1.7, .5, 0), tck=-.01)
par(pty="s")
plot(midterm, y, xlab="Midterm exam score", ylab="Final exam score", xlim=c(0,100), ylim=c(0,100), xaxs="i", yaxs="i",  type="n", main="Unalanced treatment assignment", cex.main=0.9)
points(midterm[z==0], y[z==0], col="blue", pch=20, cex=0.5)
points(midterm[z==1], y[z==1], col="red", pch=20, cex=0.5)
grid(5, 5)
abline(a, b, col="blue")
...
par(mar=c(3, 3, 2, 1), mgp=c(1.7, .5, 0), tck=-.01)
par(pty="s")
plot(midterm, y, xlab="Midterm exam score", ylab="Final exam score", xlim=c(0,100), ylim=c(0,100), xaxs="i", yaxs="i",  type="n", main="Nonlinear model, balanced assignment", cex.main=0.9)
points(midterm[z==0], y[z==0], col="blue", pch=20, cex=0.5)
points(midterm[z==1], y[z==1], col="red", pch=20, cex=0.5)
grid(5, 5)
...
par(mar=c(3, 3, 2, 1), mgp=c(1.7, .5, 0), tck=-.01)
par(pty="s")
plot(midterm, y, xlab="Midterm exam score", ylab="Final exam score", xlim=c(0,100), ylim=c(0,100), xaxs="i", yaxs="i",  type="n", main="Nonlinear model, unbalanced assignment", cex.main=0.9)
points(midterm[z==0], y[z==0], col="blue", pch=20, cex=0.5)
points(midterm[z==1], y[z==1], col="red", pch=20, cex=0.5)
grid(5, 5)
curve(5 + 90*invlogit(((a + b*x) - 50)/15), col="blue", add=TRUE)
