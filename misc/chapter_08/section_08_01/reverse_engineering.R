...
# weird_outcome <- (sims[, "AL"] < 0) |
#   (sims[, "AR"] < 0) |
#   (sims[, "KY"] < 0) |
#   (sims[, "LA"] < 0) |
#   (sims[, "IN"] < 0) | (sims[, "KS"] < 0) | (sims[, "ND"] < 0)
...
plot(rng, rng, 
     xlab = "Trump vote share in New Jersey", 
     ylab = "Trump vote share in Alaska", 
     main = "40,000 simulation draws", 
     cex.main = 0.9, bty = "l", type = "n")
...
plot(rng, rng, 
     xlab = "Trump vote share in New Jersey", 
     ylab = "Trump vote share in Alaska", 
     main = "Only 1000 simulation draws", 
     cex.main = 0.9, bty = "l", type = "n")
polygon(c(0.5, 0.5, 1, 1), c(0, 1, 1, 0), border = NA, col = "pink")
...
plot(rng, rng, 
     xlab = "Trump vote share in New Jersey", 
     ylab = "Trump vote share in Pennsylvania", main = "40,000 simulation draws", 
     cex.main = 0.9, bty = "l", type = "n")
polygon(c(0.5, 0.5, 1, 1), c(0, 1, 1, 0), border = NA, col = "pink")
...
plot(rng, rng, 
     xlab = "Trump vote share in New Jersey", 
     ylab = "Trump vote share in Pennsylvania", 
     main = "Only 1000 simulation draws", 
     cex.main = 0.9, bty = "l", type = "n")
polygon(c(0.5, 0.5, 1, 1), c(0, 1, 1, 0), border = NA, col = "pink")
...
plot(rng, rng, 
     xlab = "Trump vote share in Alabama", 
     ylab = "Trump vote share in Mississippi", 
     main = "40,000 simulation draws", 
     cex.main = 0.9, bty = "l", type = "n")
polygon(c(0.5, 0.5, 1, 1), c(0, 1, 1, 0), border = NA, col = "pink")
...
plot(rng, rng, 
     xlab = "Trump vote share in Wisconsin", 
     ylab = "Trump vote share in Pennsylvania", 
     main = "40,000 simulation draws", 
     cex.main = 0.9, bty = "l", type = "n")
polygon(c(0.5, 0.5, 1, 1), c(0, 1, 1, 0), border = NA, col = "pink")
...
plot(rng, rng, 
     xlab = "Trump vote share in Washington", 
     ylab = "Trump vote share in Mississippi", 
     main = "40,000 simulation draws", 
     cex.main = 0.9, bty = "l", type = "n")
polygon(c(0.5, 0.5, 1, 1), c(0, 1, 1, 0), border = NA, col = "pink")
...
check <- rbind(sims_538$maps[[1]], sims_538$maps[[2]], sims_538$maps[[3]], 
               sims_538$maps[[4]], sims_538$maps[[5]])
...
plot(rng, rng, 
     xlab = "Trump vote share in New York", 
     ylab = "Trump vote share in Pennsylvania", 
     main = "40,000 simulation draws", 
     cex.main = 0.9, bty = "l", type = "n")
polygon(c(0.5, 0.5, 1, 1), c(0, 1, 1, 0), border = NA, col = "pink")
